...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> {{ __('messages.categories') }}</h4>
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">{{ __('messages.categories') }}</span>
            </div>
        </div>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                <button aria-expanded="false" aria-haspopup="true"
                                                    ...
                                                    type="button"> {{ __('messages.actions') }}<i
                                                        class="fas fa-caret-down ml-1"></i></button>
                                                <div class="dropdown-menu tx-13">
                                                    <a class="dropdown-item"
                                                        href=" {{ url('edit_category') }}/{{ $category->id }}">{{ __('messages.edit') }}</a>
                                                    <a class="dropdown-item" href="#"
                                                        data-category_id="{{ $category->id }}" data-toggle="modal"
                                                        data-target="#delete_category"><i
                                                            class="text-danger fas fa-trash-alt"></i>{{ __('messages.delete') }}</a>
                                                </div>
                                            </div>
